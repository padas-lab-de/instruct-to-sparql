...
if __name__ == "__main__":
    ...
    def flatten_instructions(examples):
        ...
        for i in range(len(examples["id"][:limit])):
            ...
            new_examples["complexity"].extend([examples["complexity"][i]] * n_sample_instructions)
            new_examples["complexity_description"].extend([examples["complexity_description"][i]] * n_sample_instructions)
